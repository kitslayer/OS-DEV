...
| 370| **shell `tac`** — `tac FILE` prints a file's lines in reverse order (cat backwards; e.g. view a log bottom-up). Verified: `tac MOTD.TXT` → line 2 then line 1 | [user/shell.c](user/shell.c) | [user/typing.c](user/typing.c) |
