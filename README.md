...
| 358| **shell `roll`** — `roll NdM` rolls N M-sided dice (`roll 2d6`; bare `roll 6` = 1d6), printing each die and the total, via a lazily clock-seeded xorshift RNG. Verified: `roll 2d6` → `4 5 total 9`, `roll 4d10` → `9 5 10 4 total 28` (all in range, correct sums) | [user/shell.c](user/shell.c) | [user/typing.c](user/typing.c) |
