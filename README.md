...
| 352| **shell `nl`** — `nl FILE` prints a file with line numbers (`cat -n` style), rounding out the text tools beside `cat`/`head`/`tail`/`sort`/`grep`/`wc`. Verified: numbers MOTD.TXT's lines | [user/shell.c](user/shell.c) | [user/typing.c](user/typing.c) |
