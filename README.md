...
[![Milestones](https://img.shields.io/badge/milestones-1864-blue)](WHATS-NEXT.md)
[![Tests](https://img.shields.io/badge/tests-82%20passing-brightgreen)](tests/README.md)
...
> [!NOTE]
> **This is an experiment in how far an AI coding agent can be driven to build a real operating system.** Every line of code in this repository was written by **Claude** (Anthropic's AI, via [Claude Code](https://claude.com/claude-code)) — the human maintainer has written **zero lines of code** across the entire project. The human's role is direction, not implementation: deciding what to build next, running it, testing it, and reviewing the result. Everything else — the kernel, the TLS stack, the JavaScript engine, the browser, all ~82k lines — was generated by Claude.
