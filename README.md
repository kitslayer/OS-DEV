...
| 366| **`head`/`tail -N`** — an optional count sets the lines shown (`head -5 FILE`, default 20) — the core head/tail parameter. Verified: `head -1 MOTD.TXT` → first line + `...`; `tail -1 MOTD.TXT` → last line | [user/shell.c](user/shell.c) | [user/typing.c](user/typing.c) |
