...
| 369| **shell `rev`** — `rev <text>` prints its argument reversed (pure, no file/kernel touch). Verified: `rev hello world` → `dlrow olleh` | [user/shell.c](user/shell.c) | [user/typing.c](user/typing.c) |
