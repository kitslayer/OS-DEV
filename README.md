...
| 355| **shell `factor`** — `factor <n>` prints a number's prime factorization (trial division to ~√n, divisor capped at 3M; handles up to 64-bit). Verified: `factor 360` → `2 2 2 3 3 5`, `factor 97` → `97`, `factor 1000000007` → itself (correctly identifies the prime 10⁹+7) | [user/shell.c](user/shell.c) | [user/typing.c](user/typing.c) |
