...
| 199| **Form submission (GET)** — submit button builds `action?name=value`, URL-encodes, navigates (verified live over HTTPS) | [docs/199](docs/199-form-submit.md) |
