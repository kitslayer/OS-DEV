...
| 367| **shell `seq`** — `seq N` prints 1..N (space-separated, capped at 1000) — a pure sequence generator, no file/kernel touch. Verified: `seq 8` → `1 2 3 4 5 6 7 8` | [user/shell.c](user/shell.c) | [user/typing.c](user/typing.c) |
