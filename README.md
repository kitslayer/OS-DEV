...
| 353| **shell `morse`** — `morse <text>` prints **and** beeps the Morse code (PC speaker: dot = short, dash = long) for letters/digits with timed inter-symbol/character/word gaps — a fun audio+visual speaker showcase. Verified: `morse sos os` → `... --- ...  --- ...` | [user/shell.c](user/shell.c) | [user/typing.c](user/typing.c) |
