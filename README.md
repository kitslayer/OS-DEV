...
| 389| **Magic 8-Ball browser toy** (`file:8ball.htm`, demo index) — click Ask and the DOM shows one of twelve classic answers via `Math.random(12)`. A fun one-button toy. Verified live: Ask → "Cannot predict now." | [tools/mkfatfs.c](tools/mkfatfs.c) |
