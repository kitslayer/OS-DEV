...
static const struct {
    ...
    { "TAGNAME HTM", "<h1>element.tagName</h1>"
        ...
        "</script>" },
    { "STYLE   HTM", "<h1>Inline CSS color</h1>"
        "<p>A small subset of CSS &mdash; the <code>color:</code> property in an inline <code>style=\"...\"</code> attribute &mdash; now tints text:</p>"
