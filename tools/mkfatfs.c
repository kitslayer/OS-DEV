...
static const struct {
    ...
    { "MARGIN  HTM", "<h2>CSS margins</h2><p>Para 1 &mdash; no margin, default spacing.</p><p style=\"margin-top:60px\">Para 2 has <b>margin-top:60px</b> &mdash; a big gap should sit above it.</p><p style=\"margin-top:10px\">Para 3 has margin-top:10px &mdash; a small gap.</p><p>Para 4 &mdash; no margin again.</p><div style=\"margin:40px\">A div with margin:40px (shorthand &mdash; the top value spaces it).</div><p>After the div.</p>" },
