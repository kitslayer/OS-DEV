...
static const struct {
    ...
    { "LIFE    HTM", "<h1>Conway's Game of Life</h1>"
        ...
        "<pre id=\"grid\"></pre>"
        "<p><button onclick=\"step()\">[ Step ]</button> &nbsp; <button onclick=\"seed()\">[ Reseed ]</button></p>"
