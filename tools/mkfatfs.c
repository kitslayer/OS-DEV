...
static const struct {
    ...
    { "CANVAS  HTM", "<h2>Canvas 2D drawing</h2><p>This 260&times;140 canvas is drawn entirely by a page script via the JS 2D context (<code>getContext('2d')</code> + <code>fillStyle</code> + <code>fillRect</code>) &mdash; M1796:</p><canvas id=\"c\" width=\"260\" height=\"140\"></canvas><script>var x=document.getElementById('c').getContext('2d'); x.fillStyle='#e0e0ff'; x.fillRect(0,0,260,140); x.fillStyle='#cc0000'; x.fillRect(20,20,80,50); x.fillStyle='#00aa00'; x.fillRect(120,20,80,50); x.fillStyle='#2266ee'; x.fillRect(70,80,120,40);</script><p>Three coloured rectangles &mdash; red, green, blue &mdash; on a pale panel, all drawn in JavaScript.</p>" },
