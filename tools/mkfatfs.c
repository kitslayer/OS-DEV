...
static const struct {
    ...
    { "CHECK   HTM", "<h1>Checkboxes &amp; radios</h1>"
        ...
        "<p>A checked box submits <code>name=on</code> with the form; an unchecked one is omitted. (Radios toggle independently for now &mdash; no group exclusion yet.)</p>" },
