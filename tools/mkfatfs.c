...
static const struct {
    ...
    { "ANCHOR  HTM", "<h1 id=\"top\">In-page anchors</h1>"
        ...
        "<ul><li><a href=\"#a\">Section A</a><li><a href=\"#b\">Section B</a><li><a href=\"#c\">Section C (bottom)</a></ul>"
