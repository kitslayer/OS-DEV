...
static const struct {
    ...
    { "MARGIN  HTM", "<style>.gap{margin-top:55px}</style><h2>CSS margins</h2><p>Para 1 &mdash; no margin, default spacing.</p><p style=\"margin-top:60px\">Para 2 has inline <b>margin-top:60px</b> &mdash; a big gap should sit above it.</p><p style=\"margin-top:10px\">Para 3 has margin-top:10px &mdash; a small gap.</p><p>Para 4 &mdash; no margin again.</p><p class=\"gap\">Para 5 uses a <b>&lt;style&gt; rule</b> <code>.gap{margin-top:55px}</code> &mdash; a big gap from a stylesheet rule, not inline.</p><p style=\"padding-top:45px\">Para 6 has <b>padding-top:45px</b> &mdash; inner top space (also lifts it down).</p><div style=\"margin:40px\">A div with margin:40px (shorthand &mdash; the top value spaces it).</div><p>After the div.</p>" },
