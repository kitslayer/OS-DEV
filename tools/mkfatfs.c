...
static const struct {
    ...
    { "HELP    HTM", "<html><head><title>OS-DEV Help</title>"
        ...
        "<dl>"
        "<dt>shell, clock, calc, editor</dt><dd>a terminal, a clock dashboard, a calculator, a text editor</dd>"
        "<dt>games</dt><dd>snake, 2048, life, tetris, breakout, mines, sudoku, maze, adv (a text adventure) &mdash; all in colour</dd>"
        "<dt>tools</dt><dd>calendar (month view), mandel (a Mandelbrot explorer), piano (the keyboard plays notes)</dd>"
        "</dl>"
        "<h2>Shell commands</h2>"
        "<p>Files: <code>ls cat edit write rm cp mv mkdir cd pwd tree find grep hexdump wc</code>. "
        "Net: <code>get URL</code>, <code>wget URL FILE</code>, <code>browse URL</code>, <code>ping</code>, <code>resolve HOST</code>. "
        "Crypto: <code>sha256 FILE</code>, <code>crypt</code>, <code>base64</code>. "
        "Also: <code>js</code>, <code>cal</code>, <code>date</code>, <code>mem</code>, <code>ps</code>, <code>df</code>, <code>beep</code>, <code>clear</code>. Type <code>help</code> in the shell for the full list.</p>"
        "<h2>Keyboard</h2>"
